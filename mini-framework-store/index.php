    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8 mx-auto text-center">
                <h1 class="hero-title fade-in">Welcome to Hanami Haven</h1>
            ...
            <div class="col-md-4 mb-4">
                <div class="card category-card h-100 shadow-hover">
                    <div class="card-body text-center">
                        ...
                        <a href="#" class="btn btn-outline-primary mt-3 category-filter-btn" data-category="<?php echo $category['id']; ?>">
                            View Products
                        </a>
                    </div>
                </div>
            ...
            <div class="card category-sidebar mb-4">
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        <a href="#" class="list-group-item list-group-item-action <?php echo !$selectedCategory ? 'active' : ''; ?>" data-category="all">
        ...
        <div class="col-md-9">
            ...
            <?php else: ?>
                ...
                <?php foreach($productsList as $product): ?>
                    <div class="col-md-4 mb-4" data-category-id="<?php echo $product['category_id']; ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    const categoryLinks = document.querySelectorAll('.list-group-item[data-category], .category-filter-btn');
    ...
    categoryLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            productCards.forEach(card => {
                const cardCategoryId = card.closest('.col-md-4').getAttribute('data-category-id');
                if (selectedCategory === 'all' || cardCategoryId === selectedCategory) {
